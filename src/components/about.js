            ...
            <div className={styles.aboutContainer}>
              ...
              <div className={styles.text}>
                <p>
                  ...
                  proficiency in both frontend and backend development expanded
                  through hands-on experience with Node, Express, React, and
                  various APIs. I adeptly managed databases such as MongoDB,
                  Mongoose, MySQL and PostgreSQL. <br />
